...
JOYSTICK_LOG_PATH = os.path.join(LOG_DIR, "joystick.log")
MAX_LOG_NUM = 50
...
def clear_trash():
    ...
    for trash in trash_list:
        try:
            ...
            print("[Error in Logger] removing trash file - " + str(e))
    ...
    while True:
        ...
        if len(log_list) < MAX_LOG_NUM:
            ...
            try:
                ...
                print("[Error in Logger] removing old log - " + str(e))
                break
