...
class ControlTraceLogger:
    ...
    SCALAR_FIELDS: List[str] = [
        ...
        "task_input_source",
        "tau_filter_enabled",
        "tau_filter_time_constant_sec",
        "tau_filter_alpha",
        "line_input_stabilizer_enabled",
        "line_input_stabilizer_method",
        "line_input_stabilizer_alpha",
        "line_input_stabilizer_time_constant_sec",
        "line_input_stabilizer_slew_rate_limit",
        "line_input_velocity",
        "line_filtered_velocity",
